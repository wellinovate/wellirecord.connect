      ...
      <div className="bg-white border-b border-slate-200 flex-shrink-0 z-20 shadow-sm">
          ...
          <div className="px-8 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
                <button className="px-4 py-2 bg-indigo-50 text-indigo-700 font-bold rounded-lg hover:bg-indigo-100 flex items-center gap-2 text-sm transition-colors border border-indigo-100">
